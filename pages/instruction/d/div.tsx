    ...
    description: (
        <>
            <p>
                ...
                For <Unit value={8} unit="bit" /> operand size, the dividend is located <Register name="AH" />, and the quotient is stored <Register name="AL" /> and the remainder in <Register name="AH" />.
                For non-<Unit value={8} unit="bit" /> operand sizes, the located in the <Register name="rDX:rAX" /> register pair, and the quotient is stored in <Register name="rAX" /> and the remainder in <Register name="rDX" />.
            </p>
            <p>
