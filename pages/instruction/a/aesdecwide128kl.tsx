...
const PageData: InstructionPageLayoutProps = {
    id: "aesdecwide128kl",
    title: <>Perform 10 Rounds of AES-128 Decryption with Key Locker on Eight Blocks</>,
    titlePlain: "Perform 10 Rounds of AES-128 Decryption with Key Locker on Eight Blocks",
    opcodes: [
        {
            opcode: <>F3 0F 38 D8 !(11):001:bbb</>,
            mnemonic: <>AESDECWIDE128KL <i>m384</i></>,
            encoding: "m",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Decrypt eight separate blocks (in <Register name="XMM0" /> through <Register name="XMM7" />) using a 128 bit AES key indicated by the handle in <i>m384</i>.
    ...
    description: (
        <>
            <p>
                The <code>AESDECWIDE128KL</code> instruction performs 10 rounds of AES-128 decryption against eight separate blocks stored in <Register name="XMM0" /> through <Register name="XMM7" />.
        ...
        `public void AESDECWIDE128KL(bit[] handle)
{
    ...
    intrinsics: [
        "unsigned char _mm_aesdecwide128kl_u8(__m128i odata[8], __m128i idata[8], const void* h)",
    ],
    exceptions: {
        real: {
