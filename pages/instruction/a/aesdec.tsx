...
const PageData: InstructionPageLayoutProps = {
    ...
    titlePlain: "Perform One Round of AES Decryption",
    opcodes: [
        {
            opcode: <>66 0F 38 DE /r</>,
            mnemonic: <>AESDEC <i>xmm1</i>, <i>xmm2/m128</i></>,
            encoding: "legacy",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Perform one round of AES decryption using one 128 bit state from <i>xmm1</i> with one 128 bit round key from <i>xmm2/m128</i>.
                    Store the result in <i>xmm1</i>.
                </>,
        },
        {
            opcode: <>VEX.128.66.0F38.WIG DE /r</>,
            mnemonic: <>VAESDEC <i>xmm1</i>, <i>xmm2</i>, <i>xmm3/m128</i></>,
            encoding: "vex",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Perform one round of AES decryption using one 128 bit state from <i>xmm2</i> with one 128 bit round key from <i>xmm3/m128</i>.
                    Store the result in <i>xmm1</i>.
                </>,
        },
        {
            opcode: <>VEX.256.66.0F38.WIG DE /r</>,
            mnemonic: <>VAESDEC <i>ymm1</i>, <i>ymm2</i>, <i>ymm3/m256</i></>,
            encoding: "vex",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Perform one round of AES decryption using two 128 bit states from <i>ymm2</i> with two 128 bit round keys from <i>ymm3/m256</i>.
        ...
        {
            opcode: <>EVEX.128.66.0F38.WIG DE /r</>,
            mnemonic: <>VAESDEC <i>zmm1</i>, <i>zmm2</i>, <i>zmm3/m512</i></>,
            encoding: "evex",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Perform one round of AES decryption using four 128 bit states from <i>zmm2</i> with four 128 bit round keys from <i>zmm4/m512</i>.
    ...
    description: (
        <>
            <p>
                The <code>(V)AESDEC</code> instruction performs a single round of AES decryption using one, two, or four 128 bit states from the first source operand using 128 bit round keys from the second source operand.
                The result is stored in in the destination operand.
            </p>
            <p>
                Due to the nature of AES, this instruction must be used for <em>all but the last</em> decryption round.
                For that last round, use the <Instruction name="aesdeclast" /> instruction.
            </p>
            <p>
                {Canned.LegacySimd}
            </p>
