...
const PageData: InstructionPageLayoutProps = {
    ...
    opcodes: [
        {
            opcode: <>0F AB /r</>,
            mnemonic: <>BTS <i>r/m16</i>, <i>r16</i></>,
            encoding: "mr",
            validity: {
                16: "valid",
                32: "valid",
            ...
            description:
                <>
                    ...
                    Set that bit in the source operand.
                </>,
        },
        {
            opcode: <>0F AB /r</>,
            mnemonic: <>BTS <i>r/m32</i>, <i>r32</i></>,
            encoding: "mr",
            validity: {
                16: "valid",
                32: "valid",
        ...
        },
        {
            ...
            mnemonic: <>BTS <i>r/m64</i>, <i>r64</i></>,
            encoding: "mr",
            validity: {
                16: "n/e",
                32: "n/e",
        ...
        {
            opcode: <>0F BA /5 <i>ib</i></>,
            mnemonic: <>BTS <i>r/m16</i>, <i>imm8</i></>,
            encoding: "mi",
            validity: {
                16: "valid",
                32: "valid",
        ...
        {
            opcode: <>0F BA /5 <i>ib</i></>,
            mnemonic: <>BTS <i>r/m32</i>, <i>imm8</i></>,
            encoding: "mi",
            validity: {
                16: "valid",
                32: "valid",
        ...
        {
            opcode: <>REX.W 0F BA /5 <i>ib</i></>,
            mnemonic: <>BTS <i>r/m64</i>, <i>imm8</i></>,
            encoding: "mi",
            validity: {
                16: "n/e",
                32: "n/e",
    ...
    description: (
        <>
            <p>
                The <code>BTS</code> instruction selects a bit from the first source operand and stores it in <Register name="CF" />.
...
public void BTS(U64 src, U64 idx)
{
    ...
    flags: {
        CF: <>Set if the specified bit is set prior to being set. Cleared otherwise.</>,
        PF: <>Undefined.</>,
        AF: <>Undefined.</>,
        ZF: <>Unmodified.</>,
        SF: <>Undefined.</>,
