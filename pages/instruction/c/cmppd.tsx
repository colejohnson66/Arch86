...
function PseudoMnemonicLegacyTableEntry(suffix: string, imm8: number): React.ReactElement {
    return (
        <tr>
            <td><code>CMP<b>{suffix}</b>PD <i>src1</i>, <i>src2</i></code></td>
            <td><code>CMPPD <i>src1</i>, <i>src2</i>, {imm8.toString(16).padStart(2, "0").toUpperCase()}h</code></td>
        </tr>
    );
}
...
function PseudoMnemonicVectorTableEntry(suffix: string, imm8: number): React.ReactElement {
    return (
        <tr>
            <td><code>VCMP<b>{suffix}</b>PD <i>dest</i>, <i>src1</i>, <i>src2</i></code></td>
            <td><code>VCMPPD <i>dest</i>, <i>src1</i>, <i>src2</i>, {imm8.toString(16).padStart(2, "0").toUpperCase()}h</code></td>
        </tr>
    );
}
...
const PageData: InstructionPageLayoutProps = {
    id: "cmppd",
    title: <>Compare Packed Double-Precision Floating-Point Values</>,
    titlePlain: "Compare Packed Double-Precision Floating-Point Values",
    opcodes: [
        {
            ...
            description:
                <>
                    Compare packed double-precision floating-point values from <i>xmm1</i> and <i>xmm2/m128</i>.
        ...
        },
        {
            ...
            description:
                <>
                    Compare packed double-precision floating-point values from <i>xmm2</i> and <i>xmm3/m128</i>.
        ...
        },
        {
            ...
            description:
                <>
                    Compare packed double-precision floating-point values from <i>ymm2</i> and <i>ymm3/m256</i>.
                    Use bits <code>0..4</code> of <i>imm8</i> as a comparison predicate.
        ...
        },
        {
            ...
            description:
                <>
                    Compare packed double-precision floating-point values from <i>xmm1</i> and <i>xmm2/m128/m64bcst</i>.
                    Use bits <code>0..4</code> of <i>imm8</i> as a comparison predicate.
        ...
        },
        {
            ...
            description:
                <>
                    Compare packed double-precision floating-point values from <i>ymm1</i> and <i>ymm2/m256/m64bcst</i>.
                    Use bits <code>0..4</code> of <i>imm8</i> as a comparison predicate.
                    Store the result in <i>k1</i>.
                </>,
        },
        {
            ...
            description:
                <>
                    Compare packed double-precision floating-point values from <i>zmm1</i> and <i>zmm2/m512/m64bcst</i>.
                    Use bits <code>0..4</code> of <i>imm8</i> as a comparison predicate.
                    Store the result in <i>k1</i>.
                </>,
        },
    ...
    description: (
        <>
            <p>
                The <code>(V)CMPPD</code> instruction compares two, four, or eight double-precision floating-point values from the two source operands.
...
public void CMPPD(SimdU64 dest, SimdF64 src, byte predicate)
{
...
void VCMPPD_Vex(SimdU64 dest, SimdF64 src1, SimdF64 src2, byte predicate, int kl)
{
...
public void VCMPPD_Vex128(SimdU64 dest, SimdF64 src1, SimdF64 src2, byte predicate) =>
    VCMPPD_Vex(dest, src1, src2, predicate, 2);
public void VCMPPD_Vex256(SimdU64 dest, SimdF64 src1, SimdF64 src2, byte predicate) =>
    VCMPPD_Vex(dest, src1, src2, predicate, 4);

void VCMPPD_EvexMemory(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k, int kl)
{
    ComparisonFunc func = PredicateMapping32[predicate];
    for (int n = 0; n < kl; n++)
    {
...
public void VCMPPD_Evex128Memory(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k) =>
    VCMPPD_EvexMemory(dest, src1, src2, predicate, 2);
public void VCMPPD_Evex256Memory(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k) =>
    VCMPPD_EvexMemory(dest, src1, src2, predicate, 4);
public void VCMPPD_Evex512Memory(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k) =>
    VCMPPD_EvexMemory(dest, src1, src2, predicate, 8);


void VCMPPD_EvexRegister(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k, int kl)
{
    ComparisonFunc func = PredicateMapping32[predicate];
    for (int n = 0; n < kl; n++)
    {
...
public void VCMPPD_Evex128Register(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k) =>
    VCMPPD_EvexRegister(dest, src1, src2, predicate, 2);
public void VCMPPD_Evex256Register(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k) =>
    VCMPPD_EvexRegister(dest, src1, src2, predicate, 4);
public void VCMPPD_Evex512Register(KMask dest, SimdF64 src1, SimdF64 src2, byte predicate, KMask k) =>
