...
const PageData: InstructionPageLayoutProps = {
    ...
    opcodes: [
        ...
        },
        {
            ...
            mnemonic: <>VCVTPD2PS {k1z} <i>xmm1</i>, <i>xmm2/m128/m64bcst</i></>,
            encoding: "evex",
            validity: {
                16: "invalid",
                32: "valid",
        ...
        },
        {
            ...
            mnemonic: <>VCVTPD2PS {k1z} <i>ymm1</i>, <i>ymm2/m256/m64bcst</i></>,
            encoding: "evex",
            validity: {
                16: "invalid",
                32: "valid",
        ...
        },
        {
            ...
            mnemonic: <>VCVTPD2PS {k1z} <i>zmm1</i>, <i>zmm2/m512/m64bcst{er}</i></>,
            encoding: "evex",
            validity: {
                16: "invalid",
                32: "valid",
...
public void VCVTPD2PS_Evex128(SimdF32 dest, SimdF64 src, KMask k) =>
    VCVTPD2PS_EvexMemory(dest, src, k, 2);
public void VCVTPD2PS_Evex256(SimdF32 dest, SimdF64 src, KMask k) =>
    VCVTPD2PS_EvexMemory(dest, src, k, 4);
public void VCVTPD2PS_Evex512(SimdF32 dest, SimdF64 src, KMask k) =>
