...
const Canned = {
    ...
    LongModeDefaultsTo64Bit:
        <>
            In Long Mode, the default operand size is <NoWrap>64 bits</NoWrap>;
            {" "}<NoWrap>32-bit</NoWrap> operation size cannot be encoded.
            Use of the <Instruction name="osize" /> prefix changes the operand size to <NoWrap>16-bit</NoWrap>.
        </>,
    ...
    WIgnoredIn32: (arg: "vex" | "xop" | "vex+xop" | "vex+evex") => {
        ...
        return (
            <>
                The operand size is always <NoWrap>32 bits</NoWrap> if not in Long Mode.
