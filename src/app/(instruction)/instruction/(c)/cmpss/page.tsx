...
function PseudoMnemonicLegacyTableEntry(suffix: string, imm8: number): React.ReactElement {
    return (
        <tr>
            <td><code>CMP<b>{suffix}</b>SS <i>src1</i>, <i>src2</i></code></td>
            <td><code>CMPSS <i>src1</i>, <i>src2</i>, {imm8.toString(16).padStart(2, "0").toUpperCase()}h</code></td>
        </tr>
    );
}
...
function PseudoMnemonicVectorTableEntry(suffix: string, imm8: number): React.ReactElement {
    return (
        <tr>
            <td><code>VCMP<b>{suffix}</b>SS <i>dest</i>, <i>src1</i>, <i>src2</i></code></td>
            <td><code>VCMPSS <i>dest</i>, <i>src1</i>, <i>src2</i>, {imm8.toString(16).padStart(2, "0").toUpperCase()}h</code></td>
        </tr>
    );
}
...
const PageData: InstructionPageLayoutProps = {
    id: "cmpss",
    title: <>Compare Scalar Single-Precision Floating-Point Values</>,
    titlePlain: "Compare Scalar Single-Precision Floating-Point Values",
    opcodes: [
        {
            opcode: <>F3 0F C2 /r <i>ib</i></>,
            mnemonic: <>CMPSS <i>xmm1</i>, <i>xmm2/m32</i>, <i>imm8</i></>,
            encoding: "rmi",
            validity: {
                16: "invalid",
                32: "valid",
        ...
        {
            opcode: <>VEX.LIG.F3.0F.WIG C2 /r <i>ib</i></>,
            mnemonic: <>VCMPSS <i>xmm1</i>, <i>xmm2</i>, <i>xmm3/m32</i>, <i>imm8</i></>,
            encoding: "rvmi",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Compare the lowest single-precision floating-point values from <i>xmm2</i> and <i>xmm3/m32</i>.
                    Use bits <code>0..4</code> of <i>imm8</i> as a comparison predicate.
                    Store the result in <i>xmm1</i>.
                </>,
        },
        {
            opcode: <>EVEX.LLIG.F3.0F.W0 C2 /r <i>ib</i></>,
            mnemonic: <>VCMPSS <i>k1</i> {k2z}, <i>zmm1</i>, <i>zmm2/m32{sae}</i>, <i>imm8</i></>,
            encoding: "ervmi",
            validity: {
                16: "invalid",
                32: "valid",
            ...
            description:
                <>
                    Compare the lowest single-precision floating-point values from <i>zmm1</i> and <i>zmm2/m32</i>.
                    Use bits <code>0..4</code> of <i>imm8</i> as a comparison predicate.
    ...
    description: (
        <>
            <p>
                The <code>(V)CMPSS</code> instruction compares a single single-precision floating-point values from the two source operands.
                The eight bit immediate determines the operation.
                The result is stored in the destination operand.
            </p>
            <p>
                The VEX form will copy bits <code>32..127</code> from the first source operand into the destination.
                {" "}{Canned.LegacySimd}
            </p>
            <p>
                For the legacy SSE and VEX versions, the results will all be a <NoWrap>32-bit</NoWrap> <em>integer</em> (not a single-precision floating-point) of either all zeros or ones.
