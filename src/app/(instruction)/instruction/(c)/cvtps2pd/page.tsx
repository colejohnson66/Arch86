...
const PageData: InstructionPageLayoutProps = {
    ...
    opcodes: [
        ...
        },
        {
            ...
            mnemonic: <>VCVTPS2PD <i>xmm1</i> {k1z}, <i>xmm2/m64/m32bcst</i></>,
            encoding: "erm",
            validity: {
                16: "invalid",
                32: "valid",
        ...
        },
        {
            ...
            mnemonic: <>VCVTPS2PD <i>ymm1</i> {k1z}, <i>xmm2/m128/m32bcst</i></>,
            encoding: "erm",
            validity: {
                16: "invalid",
                32: "valid",
        ...
        },
        {
            ...
            mnemonic: <>VCVTPS2PD <i>zmm1</i> {k1z}, <i>ymm2/m256/m32bcst{sae}</i></>,
            encoding: "erm",
            validity: {
                16: "invalid",
                32: "valid",
