...
const PageData: InstructionPageLayoutProps = {
    ...
    description: (
        <>
            ...
            <p>
                This instruction is only valid on <NoWrap>32-bit</NoWrap> and <NoWrap>64-bit</NoWrap> operands.
                To operate on a <NoWrap>16-bit</NoWrap> operand, use the <Instruction name="xchg" /> instruction.
                Use of this instruction on a <NoWrap>16-bit</NoWrap> operand is undefined.
            </p>
        </>
    ),
    operation:
