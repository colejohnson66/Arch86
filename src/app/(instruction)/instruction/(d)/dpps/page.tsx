...
const PageData: InstructionPageLayoutProps = {
    ...
    description: (
        <>
            ...
            <p className="pt-2">
                The <code>VEX.256</code> form of the instruction operates in a manner similar to the legacy SSE form (only on <NoWrap>128 bits</NoWrap>), but on both halves of the operands.
