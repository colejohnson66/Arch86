...
export const metadata: Metadata = {
    alternates: { canonical: "https://arch86.com/register" },
    title: "Registers",
};

export default function Page(): React.ReactElement {
    return <>
        <Layout.Header>Registers</Layout.Header>
        <Layout.Body>
            <Breadcrumbs>
                <li>Registers</li>
            </Breadcrumbs>
            <Layout.Content>
                ...
                <p>
                    ...
                    These range in size from a dozen or so bits, all the way to <NoWrap>1024-byte</NoWrap> <A href="/register/tile">&quot;tiles&quot;</A> with <A href="/extension/amx">AMX</A>.
                </p>
