...
import Citations from "@/types/Citations";
...
export const metadata: Metadata = {
    alternates: { canonical: "https://arch86.com/register/flags" },
...
const citations: Citations = {
    "vk-flags": {
        ...
        url: "https://www.righto.com/2013/02/looking-at-silicon-to-understanding.html",
...
export default function Page(): React.ReactElement {
    return <>
        <Layout.Header>Flags Register</Layout.Header>
        <Layout.Body>
            <Breadcrumbs>
            ...
            <Layout.Content>
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <Ref citation={citations["vk-flags"]} />
                    </dd>
