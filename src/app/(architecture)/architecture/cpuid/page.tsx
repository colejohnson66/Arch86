...
export const metadata: Metadata = {
    alternates: { canonical: "https://arch86.com/architecture/cpuid" },
    title: "CPUID",
};

export default function Page(): React.ReactElement {
    return <>
        <Layout.Header>CPUID</Layout.Header>
        <Layout.Body>
            <Breadcrumbs>
                <li><A href="/architecture">Microarchitecture</A></li>
                <li>CPUID</li>
            </Breadcrumbs>
            <Layout.Content>
                <Toc.Root>
                ...
                <p>
                    ...
                    It returns information about the processor and supported features based on the value in <code>EAX</code> (and sometimes also <code>ECX</code>).
                </p>
                <p>
                ...
                <p>
                    The <code>EAX=0</code> leaf returns the largest basic leaf in <code>EAX</code> and a 12 byte processor identification string in the other three registers.
                </p>
                                ...
                                <table className="w-full">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>64 bit <code>DS</code> Area</td>
                                            <td><code>de</code></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><code>tsc</code></td>
                                            <td><Instruction name="rdtsc" /> and <code>CR4.TSD</code> support</td>
                                        </tr>
                                        <tr>
                                            <th>5</th>
                                            <td><code>vmx</code></td>
