...
export const metadata: Metadata = {
    alternates: { canonical: "https://arch86.com/mode" },
    title: "Operating Modes",
};

export default function Page(): React.ReactElement {
    return <>
        <Layout.Header>Operating Modes</Layout.Header>
        <Layout.Body>
            <Breadcrumbs>
            ...
            <Layout.Content>
                ...
                <ul>
                    <li><A href="/mode/unreal">Unreal Mode</A> - a variant of Real Mode, but with access to a <NoWrap>4 GiB</NoWrap> address space</li>
