...
function FormatNormalExceptionsList(list: ExceptionList | "none"): React.ReactNode {
    ...
    Object.entries(list).forEach((group) => {
        const key = group[0] as ExceptionAbbr;
        const text = group[1];
...
export default function InstructionPageLayout(props: InstructionPageLayoutProps): React.ReactElement {
    ...
    return <>
        <Layout.Header>{props.title}</Layout.Header>
        <Layout.Body>
            <Breadcrumbs>
                    ...
                    <table className="instruction-overview">
                        <thead>
                            <tr className="hidden lg:table-row">
                                ...
                                <th><NoWrap>16-bit</NoWrap></th>
                                <th><NoWrap>32-bit</NoWrap></th>
                                <th><NoWrap>64-bit</NoWrap></th>
                                            ...
                                            <td>
                                                ...
                                                {hasCpuid &&
                                                    <>
                                                        ...
                                                        {" "}{FormatCpuidListComma(CoerceToArray(row.cpuid as string[]))}
                                                    </>}
                                                <hr />
                                                {row.description}
                                            </td>
